...
# -------------------------------
    ...
    def interpret_output(value):
        if value > 0.7:
            return f"Konsumsi energi diprediksi **sangat tinggi** untuk {negara}. Hal ini menandakan kebutuhan energi besar."
        elif value > 0.4:
            return f"Konsumsi energi berada pada tingkat **menengah**. {negara} berada pada fase konsumsi energi moderat."
        else:
            return f"Konsumsi energi **rendah**. {negara} cenderung lebih efisien atau memiliki kebutuhan energi kecil."
