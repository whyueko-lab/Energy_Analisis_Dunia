...
if menu == "📊 Analisis Data":
    ...
    # --------------------------
    # Tambahan Penjelasan Korelasi
    # --------------------------
    st.markdown("""
    ### 📘 Penjelasan Korelasi
    Korelasi menunjukkan **kekuatan hubungan** antara variabel ekonomi dan energi:

    - **GDP** mencerminkan tingkat aktivitas ekonomi. Kenaikan GDP biasanya membuat kebutuhan energi ikut meningkat.
    - **Primary Energy Consumption** adalah seberapa besar total energi yang digunakan suatu negara.
    - **Carbon Intensity** menggambarkan seberapa polutif pembangkitan listrik. Nilai lebih tinggi berarti listrik masih banyak memakai energi fosil.

    **Cara membaca warna pada heatmap:**
    - Merah pekat berarti hubungan **positif kuat**, misalnya GDP naik maka konsumsi energi juga naik.
    - Biru pekat berarti hubungan **negatif kuat**.
    - Warna putih atau samar berarti hubungan **lemah** atau hampir tidak ada.

    Nilai korelasi mendekati **+1** berarti sangat terkait positif.  
    Nilai mendekati **-1** berarti terkait negatif.  
    Nilai dekat **0** berarti hubungan lemah.
    """)
